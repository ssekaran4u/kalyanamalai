...
export class SuggestionComponent implements OnInit {
        ...
        //     this.pageSetUp   = localStorage.getItem("pageSetUp");
            ...
            // {
              ...
              // && result.c_regno && result.c_office && result.c_city && result.c_country 
                const result = Object.assign({}, this.SuggestionForm.value);
                if (result.name && result.email && result.message) 
                {
                    ...
                    this.userservice.getData(user_Update_info, "WebHomePage/SuggestionSubmit", "POST").subscribe((response: any) => {
                        this.isLoading = true;
                        try {
    ...
    //     });
  	...
  	ngOnInit(): void 
	  {
	  	this.titleService.setTitle('Suggestion - Kalyanamalai');
	  }
